...
```
    ...
    "test": "concurrently -n \"BACKEND,FRONTEND\" -c \"green,yellow\" \"npm run rails-server\" \"./wait-for-rails.sh && npm run vitest '${npm_config_specPath}'\""
```
  ...
  auth: {
    ...
    provider: {
      ...
      endpoints: {
        ...
        getSession: { path: 'sessions', method: 'get' },
      },
    },
  }
});
